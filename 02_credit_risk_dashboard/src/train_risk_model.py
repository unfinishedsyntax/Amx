...
DATA_PATH = "/home/claude/projects/02_credit_risk_dashboard/data/loan_portfolio.csv"
OUT_DIR = "/home/claude/projects/02_credit_risk_dashboard/output"
...
def main():
    ...
    df.to_csv(f"{OUT_DIR}/scored_portfolio.csv", index=False)
